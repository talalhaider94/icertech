...
<div id="quickform" class="contact-us__tab"><a href="#">Test Form</a></div>



    
 <script type="text/javascript"> 
$( ".wpcf7-list-item-label" ).after( "<p>Test</p>" );
</script>  
			  ...
			  <?php endwhile; endif; ?>					
                ...
                <div class="performance-container">
                	...
                	<div class="container">
						...
						<div class="btn-perf"><a href="#">View full performance PDF</a></div>
                	</div>
                </div>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-6 no-pad bg-blue">
							...
							<a class="btn-more" href="http://www.icertech.co.uk/packaging-coolant-guide/">Read More</a>
						</div>
					</div>
				</div>
