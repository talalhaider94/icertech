                                                        ...
                                                        <td valign="top">
                                                            <div id="body_content_inner">
																...
																<div id="body_content_inner_intro">
																	<strong>Hi <?php printf( __( "%s", 'woocommerce' ), $order->billing_first_name ); ?>,</strong> Your order is now complete!
																</div>
																<hr>
...
<tbody class="prod-table-tagline" style="border:0;">
	<tr style="border:0;">
		...
		<br><br>Orders placed before midday (Monday-Friday) will be delivered within 2-3 working days, unless advised otherwise.
		</td>
	</tr>
</tbody>
</table>
